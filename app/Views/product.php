...
<html>
    ...
    <meta charset="UTF-8">
        ...
        <link rel="stylesheet" type="text/css" href ="http://localhost:8080/css/product.css">
        ...
        <!-- Javascript -->
        <script src="http://localhost:8080/js/product.js" defer></script>
        <script src="http://localhost:8080/js/main.js" defer></script>
